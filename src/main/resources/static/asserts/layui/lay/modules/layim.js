...
;layui.define(["layer", "laytpl", "upload"], function (i) {
    ...
    var x, b, w, k, C, S = function (i, a, n) {
        ...
        return i = i || {}, t.close(M.index), M.index = t.open({
            ...
            content: n(p).render({
                data: {
                    ...
                    avatar: i.avatar,
                    group: i.group || parent.layui.layim.cache().friend || [],  // 源码一改 ：parent.layui.layim.cache().friend
                    type: i.type
                }, type: a
            }),
            yes: function (e, t) {
        ...
        if (!(l.ie && l.ie < 9)) {
            ...
            i.src = "/openFeign/static/upload/voice/defaultIPhone.mp3";
            i.play()   // 已修改
        }
    }, G = {}, K = function (i) {
        i = i || {};
        ...
        status: function (i, a) {
            ...
            t.alert("版本： " + a + '<br>版权所有：<a href="https://www.layui.com/" target="_blank">www.layui.com</a>', {
                title: "关于 LayUI",
                shade: !1
            })
        }, setSkin: function (i) {
